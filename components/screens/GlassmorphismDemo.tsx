    ...
    >
      ...
      <ThemedCard variant="glass" padding="lg" style={styles.headerCard}>
        ...
        >
          <ThemedText
            ...
            weight="bold"
          >
            🎯 Light Mode Issue SOLVED: Now uses dark transparency for perfect
            visibility!
          </ThemedText>
        </ThemedCard>
      </ThemedCard>
      ...
      <ThemedCard variant="default" padding="lg" style={styles.sectionCard}>
        ...
        <ThemedText variant="body2" style={styles.usageText}>
          ...
          {"\n"}• secondary - Enhanced glassmorphism that adapts perfectly to
          all themes
          {"\n"}• glass - Light glassmorphism effect with subtle shadows
          {"\n"}• glassStrong - Enhanced glassmorphism with stronger blur and
          depth
          {"\n"}• glassPremium - Premium glassmorphism with colored borders and
          glow
          {"\n\n"}
          <ThemedText variant="body2" weight="bold">
            Card Variants:
          ...
          {"\n"}• Now uses dark transparency (rgba(0,0,0,0.08)) for perfect
          visibility
        ...
        >
          <ThemedText variant="caption" color="textSecondary" align="center">
            💡 All glassmorphism effects automatically adapt to light and dark
            themes!
          </ThemedText>
        </ThemedCard>
      </ThemedCard>
